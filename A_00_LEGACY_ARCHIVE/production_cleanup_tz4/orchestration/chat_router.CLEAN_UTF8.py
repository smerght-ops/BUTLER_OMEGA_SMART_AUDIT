...
from A_07_MEMORY.memory_layer import MemoryLayer
...
session_mgr = ButlerSessionManager()
...
def handle_draw(text, models):
    ...
    try:
        ...
        session_mgr.append("assistant", result)
        print(result)
        print("-" * 70)
