...
def handle_draw(text, models):
    ...
    resolved = resolver.resolve(clean_prompt)

    if resolved["is_hybrid"]:
        clean_prompt = f"Animal 1: {resolved['entity_1']}\nAnimal 2: {resolved['entity_2']}\nUse both animals literally.\nDo not substitute animals."
